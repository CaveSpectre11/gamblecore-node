...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `gamblecore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ gamblecore-node add wallet-service');
      console.log('    $ gamblecore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ gamblecore-node remove wallet-service');
      console.log('    $ gamblecore-node remove insight-api');
      console.log();
    });
